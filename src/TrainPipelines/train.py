...
# Save the dataset in a databsae 


# Retrieve all data saved in database
    ...
    class Model:
        ...
        def trainModel(mergedDataset):
            ...
            mergedDataset = pd.read_csv('E:/Research/CHS_Repo/CustomerHealthScoreB2B/Data/merged_dataset.csv')
